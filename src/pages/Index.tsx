...
const features = [
  ...
  {
    icon: FileText,
    title: "DEXPI Standard Compliant",
    description: "Outputs compatible with pyDEXPI for seamless integration with engineering tools.",
  },
  {
    icon: Shield,
...
const Index = () => {
  ...
  const handleSendMessage = useCallback(async (content: string) => {
    ...
    const assistantMessage: Message = {
      ...
      role: "assistant",
      content: `I've analyzed your process description and generated the P&ID structure. 
          ...
          <div className="container relative">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                ...
                from natural language descriptions, using a multi-step agentic workflow compatible with pyDEXPI.
              </p>
      ...
      <footer className="border-t border-border mt-16 py-8">
        <div className="container text-center">
          <p className="text-sm text-muted-foreground">
            Built with pyDEXPI Framework • Powered by Generative AI
          </p>
          <p className="text-xs text-muted-foreground/60 mt-2">
            Automating P&ID generation for process engineering
          </p>
        </div>
      </footer>
    </div>
